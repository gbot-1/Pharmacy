...
\vfill
\begin{center}
    \includegraphics[max width=\textwidth,max height=0.6\textheight]{{{ Map_new_implentation }}}
\end{center}
...
avec la pharmacie {{ Name_pharma_fusion }} située {{ New_adress }} - {{ New_postcode }} {{ New_town }}.

\vspace{25mm}

\section*{Coordonnées Lambert 2008}

\noindent    Adresse de fusion:\\
\noindent    X : {{ New_X }} m\\
\noindent    Y : {{ New_Y }} m\\
